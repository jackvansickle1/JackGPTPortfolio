...
const projects = [
  ...
  },
  {
    ...
    name: "Moomoo Trading Bot Status",
    ...
    howItWorks: [
      ...
      "A private host-agent exposes sanitized health to the JackGPT stack, and Market Desk relays only public-safe service status to the homepage.",
    ],
    developed: [
      ...
      "Integrated a sanitized health bridge into JackGPT Ops and the public homepage status section without leaking trade rows or account details.",
    ],
  ...
  },
  {
    ...
    howItWorks: [
      ...
      "Market Desk exposes a sanitized health endpoint that reports only generic component status and timestamps.",
    ...
    developed: [
      ...
      "Integrated Salad into the JackGPT Ops monitor and public live-status layer.",
...
const fallbackStatuses = [
  ...
  },
  {
    ...
    description: "Checking the private paper-trading runner, OpenD gateway, and scheduler.",
  ...
  },
  {
    ...
    name: "Salad Compute Node",
    description: "Checking the host compute service and workload process.",
